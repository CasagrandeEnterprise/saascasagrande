    ...
    <CatalogShell categories={headerCategories}>
      ...
      <section className="border-b border-blue-100 bg-white">
        <div className="container flex flex-col items-center gap-4 py-16 text-center">
          ...
          <h1 className="font-serif text-4xl font-bold text-slate-800 sm:text-5xl">
            Casagrande SaaS
          </h1>
          <p className="max-w-xl text-base text-slate-500">
            Monte seu pedido com praticidade, pague no Mercado Pago e acompanhe
      ...
      <div className="container py-12">
        {visibleCategories.length === 0 ? (
          <p className="py-20 text-center text-slate-500">
            O catálogo está sendo preparado. Volte em breve!
          </p>
        ) : (
