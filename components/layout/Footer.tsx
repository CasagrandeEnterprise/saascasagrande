import { Building2, Clock, Instagram, MessageCircle } from "lucide-react";
    ...
    <footer className="mt-16 border-t border-blue-100 bg-white">
      <div className="container flex flex-col items-center gap-6 py-10 text-center">
        ...
        <p className="text-sm text-slate-500">
          Plataforma digital para pedidos, catálogo e gestão do seu negócio.
        </p>

        <p className="max-w-md text-sm text-slate-500">{STORE_ADDRESS}</p>
        ...
        <div className="flex items-center gap-4">
          {socials.map(({ label, href, Icon }) => (
            <a
              ...
              aria-label={label}
              className="flex h-10 w-10 items-center justify-center rounded-full border border-blue-100 text-slate-600 transition-colors hover:border-coffee-300 hover:bg-coffee-50 hover:text-coffee-700"
            >
