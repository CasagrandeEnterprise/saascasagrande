...
export function ReviewCard({
  ...
  return (
    <article
      className={cn(
        "flex h-full flex-col rounded-xl border border-blue-100 bg-white p-5 shadow-sm",
        className
      )}
    >
      ...
      <div className="mt-4 border-t border-blue-50 pt-3">
        ...
        <p className="mt-0.5 text-xs text-slate-400">{review.productTitle}</p>
      </div>
    </article>
  );
}
...
export function HighlightedReviewsSection({
  ...
  return (
    <section className="border-t border-blue-100 bg-slate-50/80">
