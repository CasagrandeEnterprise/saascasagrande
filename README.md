# Casagrande SaaS — Catálogo Digital + Painel Admin

Catálogo digital **Mobile-First** para o **Casagrande SaaS**, com um **Painel de Administração** protegido por login e CRUD completo. Construído com **Next.js (App Router)**, **Tailwind CSS**, **shadcn/ui**, **lucide-react**, **Prisma** e **NextAuth (Auth.js v5)**.
...
ADMIN_EMAIL="admin@casagrande.com"
...
**Login padrão do admin:** `admin@casagrande.com` / `admin123`
(definido no `.env`).
...
app/
  ...
  globals.css                # Tailwind + tema safira + scroll-behavior
...
- Identidade visual: safira / azul claro / branco (`tailwind.config.ts` + `globals.css`).
